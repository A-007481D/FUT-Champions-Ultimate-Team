...
<button onclick="deletePlayer(this.parentElement.parentElement)" class=" group-hover:opacity-100 opacity-0 card-btns-2 bg-red-500 hover:bg-red-700 text-white font-bold py-1.5 px-3 rounded">
